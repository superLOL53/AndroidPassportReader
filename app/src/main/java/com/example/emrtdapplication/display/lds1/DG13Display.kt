...
object DG13Display : CreateView() {
    ...
    override fun <T : LinearLayout> createView(context: Context, parent: T) {
        ...
        if (EMRTD.showDetails) {
            ...
            text.text = context.getString(R.string.dg13_file_content)
            parent.addView(text)
            ...
            text.text = EMRTD.ldS1Application.dg13.rawFileContent?.toHexString(HexFormat { upperCase=true; bytes.byteSeparator = " "})
        }
    }
}