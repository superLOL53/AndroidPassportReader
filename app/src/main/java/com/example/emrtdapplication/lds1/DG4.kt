...
import com.example.emrtdapplication.UNABLE_TO_DECODE_IRIS_DATA
 ...
 * contained in the DG4 file or null if it could not be decoded
 */
class DG4: ElementaryFileTemplate() {
    ...
    override fun parse(): Int {
        ...
        try {
            ...
            Log.i(ANDROID_LOG_INFO_TAG, UNABLE_TO_DECODE_IRIS_DATA)
            isParsed = false
        }
        return SUCCESS
    }
