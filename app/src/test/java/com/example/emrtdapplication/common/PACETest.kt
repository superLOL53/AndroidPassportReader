...
class PACETest {
    ...
    private var keyParametersDH = mutableListOf<DHParameters>()
    private var keyParametersECDH = mutableListOf<ECDomainParameters>()
    private var generatedKeys = ArrayList<AsymmetricCipherKeyPair>()
    private var encKey = slot<ByteArray>()
    ...
    fun setUp() {
        ...
        keyParametersDH = mutableListOf()
        keyParametersECDH = mutableListOf()
        generatedKeys = ArrayList()
        encKey = slot()
        macKey = slot()
        sequenceCounter = slot()
    ...
    fun testDHGM() {
        ...
        responseAPDUs.add(
            BigInteger("7C128010854D8DF5827FA6852D1A4FA701CDDDCA9000", 16).toByteArray()
        )
        responseAPDUs.add(BigInteger("7C818382818078879F57225AA8080D52ED0FC890A4B2" +
                "5336F699AA89A2D3A189654AF70729E623EA5738B26381E4DA19E004706FACE7B235C2D" +
                "BF2F38748312F3C98C2DD4882A41947B324AA1259AC22579DB93F7085655AF30889DBB8" +
                "45D9E6783FE42C9F2449400306254C8AE8EE9DD812A804C0B66E8CAFC14F84D8258950A" +
                "91B44126EE69000", 16).toByteArray())
        responseAPDUs.add(BigInteger("7C8183848180075693D9AE941877573E634B6E644F8E60AF" +
        ...
        responseAPDUs.add(BigInteger("7C0A8608917F37B5C0E6D8D19000", 16).toByteArray())
        ...
        generatedKeys.add(
            AsymmetricCipherKeyPair(
                DHPublicKeyParameters(
                    BigInteger("23FB3749EA030D2A25B278D2A562047ADE3F01B74F17A15402CB" +
                            "7352CA7D2B3EB71C343DB13D1DEBCE9A3666DBCFC920B49174A602CB47965CAA7" +
                            "3DC702489A44D41DB914DE9613DC5E98C94160551C0DF86274B9359BC0490D01B" +
                            "03AD54022DCB4F57FAD6322497D7A1E28D46710F461AFE710FBBBC5F8BA166F43" +
                            "11975EC6C", 16),
                    DHStandardGroups.rfc5114_1024_160),
                DHPrivateKeyParameters(
                    BigInteger("5265030F751F4AD18B08AC565FC7AC952E41618D", 16),
                    DHStandardGroups.rfc5114_1024_160)
            )
        )
        generatedKeys.add(
            AsymmetricCipherKeyPair(
                DHPublicKeyParameters(
                    BigInteger("00907D89E2D425A178AA81AF4A7774EC8E388C115CAE67031E85E" +
                            "ECE520BD911551B9AE4D04369F29A02626C86FBC6747CC7BC352645B6161A2A42D" +
                            "44EDA80A08FA8D61B76D3A154AD8A5A51786B0BC07147057871A922212C5F67F43" +
                            "173172236B7747D1671E6D692A3C7D40A0C3C5CE397545D015C175EB5130551EDB" +
                            "C2EE5D4", 16),
                    DHParameters(dh.p, g, dh.q)),
                DHPrivateKeyParameters(
                    BigInteger("0089CCD99B0E8D3B1F11E1296DCA68EC53411CF2CA", 16),
                    DHParameters(dh.p, g, dh.q)
                )
            )
        )
        ...
        every {
            Crypto.generateDHKeyPair(capture(keyParametersDH))
        } returnsMany generatedKeys
        val pace = PACE()
        pace.init("T22000129364081251010318", false,
            byteArrayOf(0x04, 0x00, 0x7F, 0x00, 0x07, 0x02, 0x02, 0x04, 0x01, 0x02),
            0x00)
        ...
        assertArrayEquals(BigInteger("1086000086" +
                "7C818381818023FB3749EA030D2A25B278D2A5" +
                ...
                "710F461AFE710FBBBC5F8BA166F4311975EC6C00", 16).toByteArray(),
            sentAPDUs[2].getByteArray())
        assertArrayEquals(BigInteger("10860000867" +
                "C8183838180907D89E2D425A178AA81AF4A77" +
                ...
                "3C5CE397545D015C175EB5130551EDBC2EE5D400", 16).toByteArray(),
            sentAPDUs[3].getByteArray())
        assertArrayEquals(BigInteger("008600000C7C0A8508B46DD9BD4D98381F00", 16).toByteArray(), sentAPDUs[4].getByteArray())
        ...
        assertArrayEquals(BigInteger("00B10B8F96A080E01DDE92DE5EAE5D54EC" +
                ...
                "E68CFDA76D4DA708DF1FB2BC2E4A4371", 16).toByteArray(),
            keyParametersDH[0].p.toByteArray())
        assertArrayEquals(BigInteger("A4D1CBD5C3FD34126765A442EFB99905" +
                ...
                "858F4DCEF97C2A24855E6EEB22B3B2E5", 16).toByteArray(),
            keyParametersDH[0].g.toByteArray())
        assertArrayEquals(
            BigInteger("F518AA8781A8DF278ABA4E7D64B7CB9D49462353", 16).toByteArray(),
            keyParametersDH[0].q.toByteArray())
        assertArrayEquals(
            BigInteger("00B10B8F96A080E01DDE92DE5EAE5D54EC" +
                "52C99FBCFB06A3C69A6A9DCA52D23B61" +
                "6073E28675A23D189838EF1E2EE652C0" +
                "13ECB4AEA906112324975C3CD49B83BF" +
                "ACCBDD7D90C4BD7098488E9C219A7372" +
                ...
                "A151AF5F0DC8B4BD45BF37DF365C1A65" +
                "E68CFDA76D4DA708DF1FB2BC2E4A4371", 16).toByteArray(),
            keyParametersDH[1].p.toByteArray())
        assertArrayEquals(g.toByteArray(),
            keyParametersDH[1].g.toByteArray())
        assertArrayEquals(
            BigInteger("F518AA8781A8DF278ABA4E7D64B7CB9D49462353", 16).toByteArray(),
        ...
        assertArrayEquals(
            ...
            encKey.captured)
        assertArrayEquals(
            BigInteger("805A1D27D45A5116F73C54469462B7D8", 16).
            toByteArray().slice(1..16).toByteArray(),
            macKey.captured)
        assertArrayEquals(ByteArray(16), sequenceCounter.captured)
    ...
    fun testECGM() {
        responseAPDUs.add(byteArrayOf(0x90.toByte(), 0x00))
        responseAPDUs.add(BigInteger("7C12801095A3A016522EE98D01E76CB6B98B42C39000", 16).toByteArray())
        responseAPDUs.add(BigInteger("7C43824104824FBA91C9CBE26BEF53A0EBE7342A3B" +
                "F178CEA9F45DE0B70AA601651FBA3F5730D8C879AA" +
                "A9C9F73991E61B58F4D52EB87A0A0C709A49DC6371" +
                "9363CCD13C549000", 16).toByteArray())
        responseAPDUs.add(BigInteger("7C438441049E880F842905B8B3181F7AF7CAA9F0EF" +
                "B743847F44A306D2D28C1D9EC65DF6DB7764B22277" +
                "A2EDDC3C265A9F018F9CB852E111B768B326904B59" +
                "A0193776F0949000", 16).toByteArray())
        responseAPDUs.add(BigInteger("7C0A86083ABB9674BCE93C089000", 16).toByteArray())
        every {
            APDUControl.sendAPDU(capture(sentAPDUs))
        } returnsMany responseAPDUs
        ...
        assertArrayEquals(
            ...
            sentAPDUs[1].getByteArray())
        assertArrayEquals(
            BigInteger("10860000457C438141047ACF3EFC982EC45565A4B1" +
                "55129EFBC74650DCBFA6362D896FC70262E0C2CC5E" +
                "544552DCB6725218799115B55C9BAA6D9F6BC3A961" +
                "8E70C25AF71777A9C4922D00", 16).toByteArray(),
            sentAPDUs[2].getByteArray())
        assertArrayEquals(
            BigInteger("10860000457C438341042DB7A64C0355044EC9DF19" +
                "0514C625CBA2CEA48754887122F3A5EF0D5EDD301C" +
                "3556F3B3B186DF10B857B58F6A7EB80F20BA5DC7BE" +
                "1D43D9BF850149FBB3646200", 16).toByteArray(),
            sentAPDUs[3].getByteArray())
        assertArrayEquals(
            BigInteger("008600000C7C0A8508C2B0BD78D94BA86600", 16).toByteArray(),
            sentAPDUs[4].getByteArray())

        assertArrayEquals(BigInteger("008BD2AEB9CB7E57CB2C" +
                "4B482FFC81B7AFB9DE27" +
                "E1E3BD23C23A4453BD9A" +
                "CE3262", 16).toByteArray(),
            keyParametersECDH[0].g.xCoord.toBigInteger().toByteArray())
        ...
        assertArrayEquals(
            ...
            encKey.captured)
        assertArrayEquals(
            BigInteger("FE251C7858B356B24514B3BD5F4297D1", 16).
            toByteArray().slice(1..16).toByteArray(),
            macKey.captured)
        assertArrayEquals(ByteArray(16), sequenceCounter.captured)
    ...
    fun testDHIM() {
        responseAPDUs.add(byteArrayOf(0x90.toByte(), 0x00))
        responseAPDUs.add(BigInteger("7C1280109ABB8864CA0FF1551E620D1EF4E135109000", 16).toByteArray())
        responseAPDUs.add(byteArrayOf(0x90.toByte(), 0x00))
        responseAPDUs.add(BigInteger("7C8183848180928D9A0F9DBA450F13FC859C6F290D1D" +
        ...
        responseAPDUs.add(BigInteger("7C0A8608C2F04230187E15259000", 16).toByteArray())
        every {
            APDUControl.sendAPDU(capture(sentAPDUs))
        } returnsMany responseAPDUs
        every {
        ...
        keys.add(BigInteger("591468CDA83D65219CCCB8560233600F", 16).toByteArray())
        keys.add(BigInteger("591468CDA83D65219CCCB8560233600F", 16).toByteArray())
        keys.add(BigInteger("01AFC10CF87BE36D8179E87370171F07", 16).toByteArray())
        keys.add(BigInteger("23F0FBD05FD6C7B8B88F4C8309669061", 16).toByteArray())
        every {
            Crypto.computeKey(any<String>(), any<ByteArray>(), any())
        } returnsMany keys
        ...
        assertArrayEquals(BigInteger("10860000867C81838381800F0CC62945A8029251FB7EF3C094E12E" +
                ...
                "1492344C852906919538C98A4BA4187E" +
                "76CE9D87832386D319CE2E043C3343AE" +
                "AE6EDBA1A9894DC5094D22F7FE1351D500", 16).toByteArray(), sentAPDUs[3].getByteArray())
        assertArrayEquals(BigInteger("008600000C7C0A850855D61977CBF5307E00", 16).toByteArray(), sentAPDUs[4].getByteArray())

        assertArrayEquals(dh.p.toByteArray(), keyParametersDH[0].p.toByteArray())
        assertArrayEquals(g.toByteArray(), keyParametersDH[0].g.toByteArray())

        assertArrayEquals(BigInteger("01AFC10CF87BE36D8179E87370171F07", 16).toByteArray(), encKey.captured)
        assertArrayEquals(BigInteger("23F0FBD05FD6C7B8B88F4C8309669061", 16).toByteArray(), macKey.captured)
        assertArrayEquals(ByteArray(16), sequenceCounter.captured)
    ...
    fun testECIM() {
        responseAPDUs.add(byteArrayOf(0x90.toByte(), 0x00))
        responseAPDUs.add(BigInteger("7C128010143DC40C08C8E891FBED7DEDB92B64AD9000", 16).toByteArray())
        responseAPDUs.add(byteArrayOf(0x90.toByte(), 0x00))
        responseAPDUs.add(BigInteger("7C4384410467F78E5F7F7686082B293E8D087E0569" +
                "16D0F74BC01A5F8957D0DE45691E51E8" +
                "932B69A962B52A0985AD2C0A271EE6A1" +
                "3A8ADDDCD1A3A994B9DED257F4D227539000", 16).toByteArray())
        responseAPDUs.add(BigInteger("7C0A860875D4D96E8D5B03089000", 16).toByteArray())
        every {
            APDUControl.sendAPDU(capture(sentAPDUs))
        } returnsMany responseAPDUs
        every {
        ...
        //TODO: Find out why key computation provides wrong key
        val keys = ArrayList<ByteArray>()
        keys.add(BigInteger("591468CDA83D65219CCCB8560233600F", 16).toByteArray())
        keys.add(BigInteger("591468CDA83D65219CCCB8560233600F", 16).toByteArray())
        keys.add(BigInteger("0D3FEB33251A6370893D62AE8DAAF51B", 16).toByteArray())
        keys.add(BigInteger("B01E89E3D9E8719E586B50B4A7506E0B", 16).
            toByteArray().slice(1..16).toByteArray()
        )
        every {
            Crypto.computeKey(any<String>(), any<ByteArray>(), any())
        ...
        assertArrayEquals(BigInteger("10860000457C4383410489CBA23FFE96AA18D824627C3E934E54" +
                ...
                "0E21FD4ED6DF42578C13418A59B34C3700", 16).toByteArray(), sentAPDUs[3].getByteArray())
        assertArrayEquals(BigInteger("008600000C7C0A8508450F02B86F6A090900", 16).toByteArray(), sentAPDUs[4].getByteArray())

        assertArrayEquals(BigInteger("008E82D31559ED0FDE92A4D0498ADD3C23" +
                "BABA94FB77691E31E90AEA77FB17D427", 16).toByteArray(), keyParametersECDH[0].g.xCoord.toBigInteger().toByteArray())

        assertArrayEquals(BigInteger("0D3FEB33251A6370893D62AE8DAAF51B", 16).toByteArray(), encKey.captured)
        assertArrayEquals(BigInteger("B01E89E3D9E8719E586B50B4A7506E0B", 16).toByteArray().slice(1..16).toByteArray(), macKey.captured)
    ...
    fun testECCAM() {
        responseAPDUs.add(byteArrayOf(0x90.toByte(), 0x00))
        responseAPDUs.add(BigInteger("7C128010CB60E8E0D85B76A9BD304747C2AD42E29000", 16).toByteArray())
        responseAPDUs.add(BigInteger("7C43824104A234236AA9B9621E8EFB73" +
        ...
        responseAPDUs.add(BigInteger("7C4384410402AD566F3C6EC7F9324509" +
        ...
        responseAPDUs.add(BigInteger("7C3C86088596CF055C67C1A38A301EEA" +
        ...
        assertArrayEquals(BigInteger("10860000457C438141047F1D410ADB7D" +
                ...
                "DCAC29969E19D0E553C100", 16).toByteArray(), sentAPDUs[2].getByteArray())
        assertArrayEquals(BigInteger("10860000457C43834104446C934084D9" +
                ...
                "0AD9BA916CF1BF86FEFC00", 16).toByteArray(), sentAPDUs[3].getByteArray())
        assertArrayEquals(BigInteger("008600000C7C0A8508E86BD06018A1CD3B00", 16).toByteArray(), sentAPDUs[4].getByteArray())

        assertArrayEquals(BigInteger("8BD2AEB9CB7E57CB2C" +
                "4B482FFC81B7AFB9DE27" +
                "E1E3BD23C23A4453BD9A" +
                "CE3262", 16).toByteArray(), keyParametersECDH[0].g.xCoord.toBigInteger().toByteArray())
        assertArrayEquals(g.xCoord.toBigInteger().toByteArray(), keyParametersECDH[1].g.xCoord.toBigInteger().toByteArray())


        assertArrayEquals(BigInteger("0A9DA4DB03BDDE39FC5202BC44B2E89E", 16).toByteArray(), encKey.captured)
        assertArrayEquals(BigInteger("4B1C06491ED5140CA2B537D344C6C0B1", 16).toByteArray(), macKey.captured)
